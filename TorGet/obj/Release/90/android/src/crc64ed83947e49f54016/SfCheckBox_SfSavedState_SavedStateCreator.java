...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Syncfusion.Android.Buttons.SfCheckBox+SfSavedState+SavedStateCreator, Syncfusion.Buttons.Android", SfCheckBox_SfSavedState_SavedStateCreator.class, __md_methods);
	}
	...
	public SfCheckBox_SfSavedState_SavedStateCreator ()
	{
		...
		if (getClass () == SfCheckBox_SfSavedState_SavedStateCreator.class)
			mono.android.TypeManager.Activate ("Syncfusion.Android.Buttons.SfCheckBox+SfSavedState+SavedStateCreator, Syncfusion.Buttons.Android", "", this, new java.lang.Object[] {  });
	}
